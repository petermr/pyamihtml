...
# local
from pyamihtml.gutil import AmiTree, Gutil, CreateToolTip
from pyamihtml.gutil import Gutil as gu
from pyamihtml.search_lib import AmiSearch, AmiSection, AmiDictionaries, AmiProjects
from pyamihtml.xml_lib import XmlLib
from pyamihtml.wikimedia import WikidataBrowser
...
class GUIArgs(AbstractArgs):
    ...
    """python -m pyamihtml.pyamix GUI --foobar
     """
