...
from pyamihtml.ami_sections import AMIFigure, AMIAbsSection
from pyamihtml.file_lib import FileLib
from pyamihtml.util import Util, AbstractArgs
...
#            assert src_file.exists(), f"file should exist {src_file}" # problem
    ...
    def pdf2html_in_ctrees(self, maxtree=9999, maxpage=9999):
        ...
        """
        """ does the same as:
        python3 -m pyamihtml.ami_pdf --inpath ../pt195/PMC6747965/fulltext.pdf --outdir ../pt195/PMC6747965/out/ 
