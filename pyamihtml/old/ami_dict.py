...
from pyamihtml.constants import LOCAL_CEV_OPEN_DICT_DIR, LOCAL_OV21_DIR, LOCAL_DICT_AMI3
from pyamihtml.ami_html import HtmlUtil, CSSStyle, H_A, H_SPAN, H_BODY, H_DIV, H_UL, H_LI, A_ID, \
    A_HREF, A_NAME, A_TITLE, A_TERM
from pyamihtml.file_lib import FileLib
from pyamihtml.util import AbstractArgs
from pyamihtml.wikimedia import WikidataSparql, WikidataLookup, WikidataPage
...
class AmiDictionary:
    ...
    def create_wikidata_page(self, entry_element):
        from pyamihtml.wikimedia import WikidataPage
