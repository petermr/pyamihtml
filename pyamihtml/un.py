...
<body class="user-contents">
    ...
    "readingOrder": [
      ...
      f"{TEMP_REPO}/CMA_1/13_20_CMA_1_section%20target.html",
      f"{TEMP_REPO}/CMA_3/1_4_CMA_3_section%20target.html",
      f"{TEMP_REPO}/CMP_16/1_10_CMP_16_section%20target.html",
      f"{TEMP_REPO}/CMP_14/1_5_CMP_14_section%20target.html",
      f"{TEMP_REPO}/CMP_15/1_7_CMP_15_section%20target.html",
      f"{TEMP_REPO}/CP_24/12_18_CP_24_section%20target.html",
      f"{TEMP_REPO}/CP_26/12_23_CP_26_section%20target.html",
      f"{TEMP_REPO}/CP_27/13_23_CP_27_section%20target.html",
      "back_cover.html"
    ]
    }},
        }}
...
print(f"**************** {VIVLIO.keys()} *************")
for key in VIVLIO.keys():
    print(f"VIVLIO {key}: {VIVLIO[key]}")
print("***********************************************")
